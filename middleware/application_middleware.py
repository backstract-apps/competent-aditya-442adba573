...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_433e80bd85c94c9298861c2a4bd24246
    """
    try:
        ...
        auth_package_secret_key = """iIFnMDkLkmQlQqZDQGuQSNWGBq03cmqa4Kda69bM5h4="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_5ba67e2f4681414ca05622b1f41eeae4
    """
    try:
